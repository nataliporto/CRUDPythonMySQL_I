...
@app.route('/productos/<id>',methods=['GET'])    # Me retorna un determinado producto del JSON, el que le pida 
def get_producto(id):
    producto=Producto.query.get(id)
    return producto_schema.jsonify(producto)

@app.route('/producto/<id>',methods=['DELETE']) # Ruta o Endpoint para ELIMINAR registros
...
@app.route('/productos', methods=['POST'])   # Ruta o Endpoint para INSERTAR un producto nuevo
def create_producto():
...
@app.route('/productos/<id>' ,methods=['PUT'])  # Ruta o Endpoint para MODIFICAR un producto nuevo
